const inventors = [
  ...
  console.log(inventors.map(inventor => inventor = {first: inventor.first, last: inventor.last}))
  ...
  console.log(inventors.find(inventor => inventor.first === "Ada"))
  
  // Array.prototype.reduce()
  // 5. How many years did all the inventors live?
  
  console.log(inventors.reduce((acc, cur) => {return acc + cur.passed - cur.year}, 0))
